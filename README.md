...
| Category (분류)         | Tools                                |
| ----------------------- | ------------------------------------ |
| Language (언어)         | Python 3.x                           |
| LLM Engine (AI)         | Google Gemini Pro (`google-generativeai`)|
| Auth & Web (인증/웹)    | YouTube Data API v3, `selenium`/`playwright` |
| Messaging (메시징)      | `python-telegram-bot`                |
| Data (데이터)           | SQLite                               |
