...
CAT1_CONFIG = {
    ...
    "feeds": [
        ...
        {
            "topic": "Agent",
            "url_ko": "https://news.google.com/rss/search?q=AI+Agent+OR+%EC%97%90%EC%9D%B4%EC%A0%84%ED%8A%B8&hl=ko&gl=KR&ceid=KR:ko",
            "url_en": "https://news.google.com/rss/search?q=%22AI+Agent%22+OR+%22Agentic+AI%22&hl=en-US&gl=US&ceid=US:en"
        }
    ]
}
...
CATEGORIES = [CAT1_CONFIG, CAT2_CONFIG]
